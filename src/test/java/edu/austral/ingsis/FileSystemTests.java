...
public class FileSystemTests {
  ...
  private final FileSystemRunner runner =
      new FileSystemRunnerImplementation(new CLI(new FileSystem(), new CommandParser()));
  ...
  void test3() {
    executeTest(
        List.of(
            ...
            entry("rm t-bone", "cannot remove directory without --recursive"),
  ...
  @Test
  void test6() {
    executeTest(List.of(entry("cd ..", "moved to directory root")));
  }
